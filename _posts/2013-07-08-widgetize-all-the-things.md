...
widget. The pattern we're going for is simple: mouseover -> add a class,
mouseout -> remove a class. That class can do whatever it wants in CSS.
...
$.fn.secret = function() {
    ...
    return this.each(function() {
        var $this = $( this );
        $this.on( 'mouseover', function() { $this.addClass( 'show' ); } );
        $this.on( 'mouseout', function() { $this.removeClass( 'show' ); } );
    });
...
other than mouseover/mouseout? What if I want some other piece of an
...
show both secrets when I mouseover the first div.
