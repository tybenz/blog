...
task :watch do
  ...
  system "sass --update _sass:_site/css/ -f -l -r ./_sass/bourbon/lib/bourbon.rb"
  jekyllPid = Process.spawn("jekyll --auto --server")
  sassPid = Process.spawn("sass --watch _sass:_site/css/ -l -r ./_sass/bourbon/lib/bourbon.rb")
